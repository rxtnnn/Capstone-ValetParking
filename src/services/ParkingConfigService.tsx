...
class ParkingConfigServiceClass {
  ...
  private getHardcodedFallbackConfig(locationId: string): ParkingLocationConfig {
    ...
    // Floor 4 configuration (sensor IDs 1-42, spot IDs: 4A1, 4B1, etc. - with floor prefix)
    const floor4Spots: ParkingSpotConfig[] = [
      { spot_id: '4A1', sensor_id: 7, position: { x: 685, y: 116 }, dimensions: { width: 57, height: 45 }, rotation: '90deg', section: 'A' },
      { spot_id: '4B4', sensor_id: 1, position: { x: 500, y: 32 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'B' },
      { spot_id: '4B3', sensor_id: 2, position: { x: 545, y: 32 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'B' },
      { spot_id: '4B2', sensor_id: 3, position: { x: 590, y: 32 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'B' },
      { spot_id: '4B1', sensor_id: 4, position: { x: 635, y: 32 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'B' },
      { spot_id: '4C1', sensor_id: 5, position: { x: 450, y: 95 }, dimensions: { width: 40, height: 55 }, rotation: '-90deg', section: 'C' },
      { spot_id: '4C2', sensor_id: 6, position: { x: 450, y: 140 }, dimensions: { width: 40, height: 55 }, rotation: '90deg', section: 'C' },
      { spot_id: '4D7', sensor_id: 14, position: { x: 100, y: 200 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'D' },
      { spot_id: '4D6', sensor_id: 13, position: { x: 160, y: 200 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'D' },
      { spot_id: '4D5', sensor_id: 12, position: { x: 210, y: 200 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'D' },
      { spot_id: '4D4', sensor_id: 11, position: { x: 259, y: 200 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'D' },
      { spot_id: '4D3', sensor_id: 10, position: { x: 310, y: 200 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'D' },
      { spot_id: '4D2', sensor_id: 9, position: { x: 355, y: 200 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'D' },
      { spot_id: '4D1', sensor_id: 8, position: { x: 400, y: 200 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'D' },
      { spot_id: '4J5', sensor_id: 42, position: { x: 270, y: 370 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'J' },
      { spot_id: '4J4', sensor_id: 41, position: { x: 320, y: 370 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'J' },
      { spot_id: '4J3', sensor_id: 40, position: { x: 380, y: 370 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'J' },
      { spot_id: '4J2', sensor_id: 39, position: { x: 440, y: 370 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'J' },
      { spot_id: '4J1', sensor_id: 38, position: { x: 490, y: 370 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'J' },
      { spot_id: '4E3', sensor_id: 17, position: { x: 55, y: 315 }, dimensions: { width: 55, height: 60 }, rotation: '90deg', section: 'E' },
      { spot_id: '4E2', sensor_id: 16, position: { x: 55, y: 380 }, dimensions: { width: 55, height: 60 }, rotation: '90deg', section: 'E' },
      { spot_id: '4E1', sensor_id: 15, position: { x: 55, y: 445 }, dimensions: { width: 55, height: 60 }, rotation: '90deg', section: 'E' },
      { spot_id: '4F1', sensor_id: 18, position: { x: 120, y: 520 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'F' },
      { spot_id: '4F2', sensor_id: 19, position: { x: 165, y: 520 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'F' },
      { spot_id: '4F3', sensor_id: 20, position: { x: 220, y: 520 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'F' },
      { spot_id: '4F4', sensor_id: 21, position: { x: 265, y: 520 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'F' },
      { spot_id: '4F5', sensor_id: 22, position: { x: 310, y: 520 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'F' },
      { spot_id: '4F6', sensor_id: 23, position: { x: 365, y: 520 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'F' },
      { spot_id: '4F7', sensor_id: 24, position: { x: 410, y: 520 }, dimensions: { width: 40, height: 55 }, rotation: '0deg', section: 'F' },
      { spot_id: '4G1', sensor_id: 25, position: { x: 500, y: 590 }, dimensions: { width: 40, height: 55 }, rotation: '90deg', section: 'G' },
      { spot_id: '4G2', sensor_id: 26, position: { x: 500, y: 650 }, dimensions: { width: 40, height: 55 }, rotation: '90deg', section: 'G' },
      { spot_id: '4G3', sensor_id: 27, position: { x: 500, y: 710 }, dimensions: { width: 40, height: 55 }, rotation: '90deg', section: 'G' },
      { spot_id: '4G4', sensor_id: 28, position: { x: 500, y: 770 }, dimensions: { width: 40, height: 55 }, rotation: '90deg', section: 'G' },
      { spot_id: '4G5', sensor_id: 29, position: { x: 500, y: 830 }, dimensions: { width: 40, height: 55 }, rotation: '90deg', section: 'G' },
      { spot_id: '4H1', sensor_id: 30, position: { x: 560, y: 890 }, dimensions: { width: 40, height: 55 }, rotation: '180deg', section: 'H' },
      { spot_id: '4H2', sensor_id: 31, position: { x: 605, y: 890 }, dimensions: { width: 40, height: 55 }, rotation: '180deg', section: 'H' },
      { spot_id: '4H3', sensor_id: 32, position: { x: 650, y: 890 }, dimensions: { width: 40, height: 55 }, rotation: '180deg', section: 'H' },
      { spot_id: '4I5', sensor_id: 37, position: { x: 680, y: 590 }, dimensions: { width: 40, height: 55 }, rotation: '270deg', section: 'I' },
      { spot_id: '4I4', sensor_id: 36, position: { x: 680, y: 650 }, dimensions: { width: 40, height: 55 }, rotation: '270deg', section: 'I' },
      { spot_id: '4I3', sensor_id: 35, position: { x: 680, y: 710 }, dimensions: { width: 40, height: 55 }, rotation: '270deg', section: 'I' },
      { spot_id: '4I2', sensor_id: 34, position: { x: 680, y: 770 }, dimensions: { width: 40, height: 55 }, rotation: '270deg', section: 'I' },
      { spot_id: '4I1', sensor_id: 33, position: { x: 680, y: 830 }, dimensions: { width: 40, height: 55 }, rotation: '270deg', section: 'I' },
    ];
