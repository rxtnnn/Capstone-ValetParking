...
export const styles = StyleSheet.create({
  ...
  arrow21: { position: 'absolute', right: 45, top: 410},
  parkingLayout: {
    width: 800,
    height: height + 200,
    backgroundColor: '#2C2C2C',
  ...
  spotActionsHeaderText: {
    flex: 1,
  },
  spotActionsModalTitle: {
    fontSize: 20,
    fontWeight: 'bold',
    color: '#fff',
    marginBottom: 2,
  ...
  spotActionsModalSubtitle: {
    fontSize: 13,
    color: 'rgba(255, 255, 255, 0.85)',
    fontFamily: FONTS.regular,
  },
  spotActionsCloseButton: {
    position: 'absolute',
    top: 12,
    right: 12,
    width: 30,
  ...
  spotActionsTabActive: {
    backgroundColor: '#111',
  },
  spotActionsTabInactive: {
    backgroundColor: '#fff',
  },
  spotActionsTabText: {
    fontWeight: '700',
  ...
  spotActionsTabTextActive: {
    color: '#fff',
  },
  spotActionsTabTextInactive: {
    color: '#333',
  },
  spotActionsContent: {
    paddingHorizontal: 20,
  ...
  spotActionsStatusRow: {
    flexDirection: 'row',
    gap: 10,
    marginBottom: 16,
  },
  spotActionsStatusOption: {
    flex: 1,
    alignItems: 'center',
    paddingVertical: 14,
    borderRadius: 10,
